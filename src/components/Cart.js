...
const Cart = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-end justify-center px-4 pb-6 sm:items-center sm:pb-20">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
            <div className="flex items-start justify-between">
              ...
              <div className="ml-3 flex h-7 items-center">
                <button type="button" className="relative -m-2 p-2 text-gray-400 hover:text-gray-500" onClick={() => navigate(-1)}>
